...
- However, we can always give an _absolute_ file path: `read_csv("/Documents/School/EC 421/Labs/lab-data.csv")`
...
- We can use the `read_csv()` function from the `dplyr` package to read our data into R. The input to `read_csv()` is a quoted path to your file (either absolute or ) 
